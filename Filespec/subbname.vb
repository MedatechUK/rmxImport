...
Public Class subbname : Inherits filespec
    ...
    Public Overrides Function Process(ByVal cols As Dictionary(Of String, String)) As SqlCommand
        Select Case cols("BUILDING")
            ...
            Case Else
                Return New SqlCommand( _
                    String.Format( _
                     "INSERT INTO ZEMG_SUBBUILD " & _
                     "(SUBBUILDINGKEY, SUBBUILDINGNAME, UPDATEDATE) " & _
                     "VALUES ({0}, '{1}', {2})", _
                     cols("BUILDING"), _
                     cols("NAME"), _
